...
const CalciteTipManager = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("section", { "aria-hidden": closed.toString(), class: CSS$1.container, hidden: closed, onKeyUp: this.tipManagerKeyUpHandler, ref: this.storeContainerRef, tabIndex: 0 }, index.h("header", { class: CSS$1.header }, index.h("h2", { class: CSS$1.heading, key: selectedIndex }, groupTitle), index.h("calcite-action", { class: CSS$1.close, icon: ICONS$1.close, onClick: this.hideTipManager, text: closeLabel })), index.h("div", { class: {
