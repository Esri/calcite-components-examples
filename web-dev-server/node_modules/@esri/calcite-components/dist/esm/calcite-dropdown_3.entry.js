...
import { C as CSS, u as updatePopper, c as createPopper } from './popper-574d6c1c.js';
...
const CalciteDropdown = class {
  ...
  render() {
    ...
    return (h(Host, { dir: dir, tabIndex: this.disabled ? -1 : null }, h("div", { class: "calcite-dropdown-trigger-container", onClick: this.openDropdown, onKeyDown: this.keyDownHandler, ref: this.setReferenceEl }, h("slot", { "aria-expanded": active.toString(), "aria-haspopup": "true", name: "dropdown-trigger" })), h("div", { "aria-hidden": (!active).toString(), class: "calcite-dropdown-wrapper", ref: this.setMenuEl, tabIndex: -1 }, h("div", { class: {
