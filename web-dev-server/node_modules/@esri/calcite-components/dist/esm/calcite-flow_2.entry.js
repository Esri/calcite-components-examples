import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-8fd57462.js';
import { f as focusElement, c as getSlotted, g as getElementDir } from './dom-d9ba1da4.js';
...
const CalcitePanel = class {
  ...
  renderHeaderContent() {
    ...
    const headingNode = heading ? h("h3", { class: CSS$1.heading }, heading) : null;
  ...
  renderMenuItems() {
    ...
    return (h("calcite-popover", { disablePointer: true, flipPlacements: ["bottom-end", "top-end"], label: intlOptions, offsetDistance: 0, onKeyDown: this.menuActionsKeydown, open: menuOpen, placement: "bottom-end", referenceElement: menuButtonEl }, h("div", { class: CSS$1.menu }, h("slot", { name: SLOTS.headerMenuActions }))));
  }
  renderMenuButton() {
    ...
    return (h("calcite-action", { "aria-label": menuLabel, class: CSS$1.menuButton, icon: ICONS.menu, onClick: this.toggleMenuOpen, onKeyDown: this.menuButtonKeyDown, ref: this.setMenuButonRef, text: menuLabel }));
  }
  renderMenu() {
    const { el } = this;
    const hasMenuItems = getSlotted(el, SLOTS.headerMenuActions);
    return hasMenuItems ? (h("div", { class: CSS$1.menuContainer, onKeyDown: this.menuActionsContainerKeyDown }, this.renderMenuButton(), this.renderMenuItems())) : null;
  }
  renderHeaderNode() {
