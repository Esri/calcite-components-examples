    ...
    return (h("div", { class: CSS.container },
      ...
      hideHex && hideChannels ? null : (h("div", { class: { [CSS.controlSection]: true, [CSS.section]: true } },
        hideHex ? null : (h("div", { class: CSS.hexOptions },
          ...
          h("calcite-color-hex-input", { class: CSS.control, dir: elementDir, onCalciteColorHexInputChange: this.handleHexInputChange, ref: (node) => (this.hexInputNode = node), scale: hexInputScale, theme: theme, value: selectedColorInHex }))),
