 ...
 * v1.2.0
 */
import { r as registerInstance, c as createEvent, h, g as getElement } from './index-7cac2f3f.js';
import { i as isPrimaryPointerButton, b as getElementDir, f as focusElement, e as getModeName } from './dom-d2c51b4f.js';
import { n as normalizeHex, C as CSSColorMode, p as parseMode, c as colorEqual, i as isValidHex, a as isLonghandHex, r as rgbToHex, b as hexChar } from './utils-35c56cd6.js';
import { u as updateHostInteraction } from './interactive-06caa37b.js';
import { i as isActivationKey } from './key-81b2634f.js';
...
import { c as clamp } from './math-a2bb65cb.js';
import { u as updateMessages, s as setUpMessages, c as connectMessages, d as disconnectMessages } from './t9n-223ccb9b.js';
import { t as throttle } from './throttle-0023c320.js';
...
const ColorPicker = class {
  ...
  render() {
    ...
    return (h("div", { class: CSS$2.container }, h("div", { class: CSS$2.colorFieldAndSliderWrap }, h("canvas", { class: {
      ...
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.storeColorFieldScope }), h("div", { "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR$1.round().hue(), class: { [CSS$2.scope]: true, [CSS$2.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, role: "slider", style: { top: `${hueTop}px`, left: `${hueLeft}px` }, tabindex: "0",
      // eslint-disable-next-line react/jsx-sort-props
