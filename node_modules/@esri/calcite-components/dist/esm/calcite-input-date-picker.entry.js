...
import { d as datePartsFromLocalizedString, a as dateFromLocalizedString, i as inRange, b as dateToISO, g as getValueAsDateRange, c as dateFromISO, e as getLocaleData, f as dateFromRange } from './utils-4755b12f.js';
import { t as toAriaBoolean } from './dom-13d14bf1.js';
import { f as filterComputedPlacements, c as connectFloatingUI, d as defaultMenuPlacement, u as updateAfterClose, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-1d9078ac.js';
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-948b3633.js';
...
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-e71d40b1.js';
import { c as connectOpenCloseComponent, d as disconnectOpenCloseComponent } from './openCloseComponent-ec590820.js';
import './guid-7a9e307b.js';
import './resources-8032eb01.js';
import './debounce-f893dc12.js';
...
const InputDatePicker = class {
  ...
  render() {
    ...
    return (h(Host, { onBlur: this.deactivate, onKeyDown: this.keyDownHandler, role: "application" }, this.localeData && (h("div", { "aria-expanded": toAriaBoolean(this.open), class: "input-container", role: "application" }, h("div", { class: "input-wrapper",
      ...
      ref: this.setStartWrapper }, h("calcite-input", { class: `input ${this.layout === "vertical" && this.range ? `no-bottom-border` : ``}`, disabled: disabled, icon: "calendar", label: getLabelText(this), "number-button-type": "none", numberingSystem: numberingSystem, onCalciteInputInput: this.calciteInternalInputInputHandler, onCalciteInternalInputBlur: this.calciteInternalInputBlurHandler, onCalciteInternalInputFocus: this.startInputFocus, placeholder: this.localeData?.placeholder, readOnly: readOnly, scale: this.scale, type: "text",
      // eslint-disable-next-line react/jsx-sort-props
