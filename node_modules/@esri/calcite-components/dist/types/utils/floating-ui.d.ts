 ...
 */
export declare function positionFloatingUI({ referenceEl, floatingEl, overlayPositioning, placement, flipDisabled, flipPlacements, offsetDistance, offsetSkidding, includeArrow, arrowEl, type }: {
