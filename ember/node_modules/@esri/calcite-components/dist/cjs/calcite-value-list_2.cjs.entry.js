...
const sortable_esm = require('./sortable.esm-0005295a.js');
const resources = require('./resources-684ec2e5.js');
...
require('./array-f1fe66d8.js');
require('./debounce-94d2834e.js');
...
const ValueListItem = class {
  ...
  renderHandle() {
    ...
    if (icon === resources.ICON_TYPES.grip) {
      return (index.h("span", { "aria-pressed": dom.toAriaBoolean(this.handleActivated), class: {
