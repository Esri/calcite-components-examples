  ...
  render() {
    ...
    return (index.h(index.Host, { tabindex: "0" }, index.h("div", { class: {
        ...
        : this.iconType === "caret"
          ...
          : this.active
            ? "minus"
            : "plus", scale: "s" })), index.h("div", { "aria-expanded": dom.toAriaBoolean(this.active), "aria-labelledby": buttonId, class: "accordion-item-content", id: regionId, role: "region" }, index.h("slot", null)))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
